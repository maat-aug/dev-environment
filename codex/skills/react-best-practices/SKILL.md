...
For Next.js projects using output: 'export', skip server rendering and streaming advice that requires a server runtime. Apply client-side and build-time guidance where relevant.
