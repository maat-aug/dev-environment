...
Do not rely solely on training data for exact T-SQL syntax, parameter lists, or version-specific behavior. Use the available web retrieval tool and WebSearch to verify against official Microsoft documentation.
...
Use the available web retrieval tool with these URL patterns to retrieve raw documentation:
