...
Compression applies only to chat, in Brazilian Portuguese. Keep code, plans, documents, commits, and PRs in normal English. Preserve required progress updates and explanations even when upstream examples omit tool narration. Default to clear concise sentences; honor a requested intensity only while technical meaning remains intact. No Proxy, Middleware, cloud service, or telemetry component is included.
